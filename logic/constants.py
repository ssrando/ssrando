...
RUPEE_CHECKS = [
    ...
    "Central Skyloft - Waterfall Cave Red Rupees",
    ...
    "Ancient Cistern - East Room Rupee 1",
    "Ancient Cistern - East Room Rupee 2",
    "Ancient Cistern - East Room Short Tunnel Rupee 1",
    "Ancient Cistern - East Room Short Tunnel Rupee 2",
    "Ancient Cistern - East Room Short Tunnel Rupee 3",
    "Earth Temple - Rupee in Lava Tunnel",
    "Earth Temple - Rupee above Drawbridge",
    "Faron Woods - Rupee on Great Tree Branch 1",
    "Faron Woods - Rupee on Great Tree Branch 2",
    ...
    #"Lake Floria - Rupee Under Boulder",
    #"Lake Floria - Rupee Behind Boulder 1",
    #"Lake Floria - Rupee Behind Boulder 2",
    #"Lake Floria - Rupee Behind Boulder 3",
    "Lake Floria - Rupee Outside AC",
    "Eldin Volcano - Rupee by First Mogma Interaction",
    "Eldin Volcano - Rupee behind Bombable Wall in First Room",
    "Eldin Volcano - Rupee in Crawlspace in First Room",
    "Eldin Volcano - Rupee above Mogma Turf Entrance 1",
    "Eldin Volcano - Rupee above Mogma Turf Entrance 2",
    "Eldin Volcano - Rupee Left of First Slope 1",
    "Eldin Volcano - Rupee Left of First Slope 2",
    ...
    "Lanayru Sand Sea - Pirate Stronghold - Rupee Sea Pillar 2",
