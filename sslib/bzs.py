...
objectstructs = {'FILE':('unk dummy', '>hh', 4),
                ...
                'PLY ':('storyflag play_cutscene byte4 posx posy posz unk2 entrance_id','>hbb3f6sh',24),
                'OBJS':('params1 params2 posx posy posz                   anglex angley anglez id name','>II3fHHHH8s',36),
                'OBJ ':('params1 params2 posx posy posz                   anglex angley anglez id name','>II3fHHHH8s',36),
                'SOBS':('params1 params2 posx posy posz sizex sizey sizez anglex angley anglez id name','>II3f3fHHHH8s',48),
                'SOBJ':('params1 params2 posx posy posz sizex sizey sizez anglex angley anglez id name','>II3f3fHHHH8s',48),
                'STAS':('params1 params2 posx posy posz sizex sizey sizez anglex angley anglez id name','>II3f3fHHHH8s',48),
                'STAG':('params1 params2 posx posy posz sizex sizey sizez anglex angley anglez id name','>II3f3fHHHH8s',48),
                'SNDT':('params1 params2 posx posy posz sizex sizey sizez anglex angley anglez id name','>II3f3fHHHH8s',48),
                'DOOR':('params1 params2 posx posy posz                   anglex angley anglez id name','>II3fHHHH8s',36),
