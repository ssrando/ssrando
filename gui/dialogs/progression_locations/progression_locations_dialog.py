...
from gui.dialogs.progression_locations.ui_progression_locations_dialog import (
    Ui_ProgressionLocationsDialog,
)


class ProgressionLocationsDialog(QDialog):
    ...
    def __init__(
        ...
        randomized_locs: str,
        # disabled_locs: str,
        randomized_locs_command: str,
        # disabled_locs_command: str,
        style_sheet: str = None,
    ):
        super().__init__()
        self.ui = Ui_ProgressionLocationsDialog()
        ...
        self.randomized_locs_command = randomized_locs_command
        # self.disabled_locs_command = disabled_locs_command

        self.randomized_locations_pair = ListPair(
            self.ui.randomized_locations,
            self.ui.enabled_locations,
            self.randomized_locs_command,
        ...
        #    self.ui.randomized_locations,
        #    self.disabled_locs_command,
        #    self.ui.disable_location,
        #    self.ui.randomize_location1,
        # )

        self.randomized_locations_pair.update(randomized_locs)
        # self.disabled_locations_pair.update(disabled_locs)
    ...
    def getRandomLocsValues(self) -> list[str]:
        return self.randomized_locations_pair.get_added()

    # def getDisabledLocsValues(self) -> list[str]:
