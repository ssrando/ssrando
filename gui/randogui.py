...
class RandoGUI(QMainWindow):
    def __init__(self, options: Options):
        ...
        getattr(self.ui, 'option_got_sword_requirement').setEnabled(False)
        getattr(self.ui, 'option_got_dungeon_requirement').setEnabled(False)
        getattr(self.ui, 'option_open_lmf').setEnabled(False)
        getattr(self.ui, 'option_map_mode').setEnabled(False)
        getattr(self.ui, 'option_small_key_mode').setEnabled(False)
        getattr(self.ui, 'option_boss_key_mode').setEnabled(False)
        ...
        getattr(self.ui, 'option_woth_hints').setEnabled(False)
        getattr(self.ui, 'option_barren_hints').setEnabled(False)
        ...
        getattr(self.ui, 'disabled_locations').setEnabled(False)
        getattr(self.ui, 'randomize_item').setEnabled(False)
        getattr(self.ui, 'start_with_item').setEnabled(False)
        getattr(self.ui, 'randomized_items').setEnabled(False)
        getattr(self.ui, 'starting_items').setEnabled(False)
