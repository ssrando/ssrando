...
# buffer is a list of u16
# def _set_flag(flag_defs: List[int], buffer: List[int], flag: int, value: int):
#     """
#     buffer: List of u16 values, representing the flags
#     flag: index of the flag
#     value: new value for the flag
#     """
#     definition = flag_defs[flag]
...
#     if value > mask:
#         raise Exception(f"flag {flag}, value {value} is greater than allowed {mask}")

#     buffer[index] = (buffer[index] & ~(mask << shift)) | (value << shift)

# def set_storyflag(buffer: List[int], flag: int, value: int):
#     _set_flag(storyflag_mapping_table, buffer, flag, value)

# def set_itemflag(buffer: List[int], flag: int, value: int):
#     _set_flag(itemflag_mapping_table, buffer, flag, value)
